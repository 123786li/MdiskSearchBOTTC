...
class Config(object):
    API_ID = int(os.getenv("API_ID", "8551663"))
    API_HASH = os.getenv("API_HASH", "3893a33d9d47b76dac4e7c804ba5c62e)
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5262326166:AAHXUSmC3nKM0xc071R0kNcasuZlUbVP7SA-x1s")
...
#   Channel id where your posts are stored.1753761719
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1753761719")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME",@Mkv_Movies_Webseris_bot "")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "1237362390"))
#   OWNER_USERNAME = os.getenv("OWNER_USERNAME", "@hidden_boy_22)
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "@mkv_hd_cinema")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("@mkv_hd_cinema", "-1001765107260")
    ...
    MDISK_API = os.getenv("MDISK_API", "Iiu612AKCq3QKbLNpLES)
